    ...
    process.nextTick(function() {
        ...
        try {
            source._pool.acquire(function(err, map) {
                ...
                // @TODO - we set buffer size in two places to prepare for
                // changes upstream in Mapnik 3.x: https://github.com/mapnik/node-mapnik/issues/175
                options.buffer_size = source._uri.query.bufferSize;
                try {
